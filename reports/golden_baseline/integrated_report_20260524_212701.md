# Golden Baseline Strategy — 20260524_212701
...
| Metric | Value | Target |
|--------|-------|--------|
| F1 weighted (test) | **0.7531** | ≥ 0.8 |
| Train–test gap (pp) | **3.48** | ≤ 4.9% |
| R-Drop | True | enabled |
